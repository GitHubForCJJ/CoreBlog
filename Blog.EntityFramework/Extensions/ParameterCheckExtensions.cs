...
namespace Blog.EntityFramework.Extensions
{
    public static class ParameterCheckExtensions
    {
        ...
        {
            Require<ArgumentNullException>(value != null, string.Format(paramName, "不能为null"));
        }
        ...
        public static void CheckNotNullOrEmpty(this string value, string paramName)
        {
            ...
            Require<ArgumentException>(value.Length > 0, string.Format(paramName, "不能为NullOrEmpty"));
        }
        ...
        {
            Require<ArgumentException>(value != Guid.Empty, string.Format(paramName, "不能为empty"));
        }
        ...
        public static void CheckNotNullOrEmpty<T>(this IEnumerable<T> collection, string paramName)
        {
            ...
            Require<ArgumentException>(collection.Any(), string.Format(paramName, "集合不能为空"));
        }
    }
}
