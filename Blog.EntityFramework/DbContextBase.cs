...
namespace Blog.EntityFramework
{
    ...
    public abstract class DbContextBase : DbContext, IDbContext
    {
        ...
        /// </summary>
        protected DbContextBase(DbContextOptions options, IServiceProvider serviceProvider,Assembly assembly)
            : base(options)
        {
        ...
        //    }
        //    //_logger?.LogInformation($"上下文“{contextType}”注册了{registers.Count()}个实体类");
        ...
        //        modelBuilder.Entity(entityType.ClrType).ToTable($"Category");
        //    }
        //}
