...
{
    public class HotNewConf : EntityTypeConfigurationBase<HotNew, int>
    {
        public override void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<HotNew> builder)
        {
