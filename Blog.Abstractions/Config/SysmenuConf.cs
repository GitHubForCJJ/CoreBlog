...
{
    public class SysmenuConf : EntityTypeConfigurationBase<Sysmenu, int>
    {
        public override void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Sysmenu> builder)
        {
            ...
            builder.Property(x => x.MenuUrl).HasMaxLength(500).IsRequired();
            builder.Property(x => x.Menuicon).HasMaxLength(500).IsRequired();
            builder.Property(x => x.Menuname).HasMaxLength(500).IsRequired();
            builder.Property(x => x.Menuremark).HasMaxLength(500).IsRequired();
        }
    }
}
