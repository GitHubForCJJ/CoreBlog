...
{
    public class MediaConf : EntityTypeConfigurationBase<Media, int>
    {
        public override void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Media> builder)
        {
