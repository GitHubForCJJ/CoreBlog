...
{
    public class CategorypicConf : EntityTypeConfigurationBase<Categorypic, int>
    {
        public override void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Categorypic> builder)
        {
